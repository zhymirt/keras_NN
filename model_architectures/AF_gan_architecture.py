...
def make_AF_discriminator(num_data_types, vector_size, summary=False):
    ...
    [
        ...
        layers.Conv2D(16, (5, 5), strides=(5, 1), padding='same'),
        layers.LeakyReLU(alpha=0.2),
        layers.Conv2D(16, (5, 5), strides=(5, 1), padding='same'),
        layers.LeakyReLU(alpha=0.2),
        layers.Conv2D(32, (3, 3), strides=(2, 1), padding='same'),
        layers.LeakyReLU(alpha=0.2),
        layers.Conv2D(32, (3, 3), strides=(2, 1), padding='same'),
        layers.LeakyReLU(alpha=0.2),
        layers.Conv2D(32, (3, 3), strides=(2, 1), padding='same'),
        layers.LeakyReLU(alpha=0.2),
        layers.Conv2D(64, (3, 1), strides=(2, 1), padding='valid'),
        layers.LeakyReLU(alpha=0.2),
        layers.Conv2D(64, (3, 1), strides=(2, 1), padding='same'),
        layers.LeakyReLU(alpha=0.2),
        layers.Conv2D(64, (3, 1), (1, 1), padding='valid'),
        layers.LeakyReLU(alpha=0.2),
        layers.Conv2D(64, (1, 5), (1, 1), padding='valid'),
        layers.LeakyReLU(alpha=0.2),
        layers.Flatten(),
        # layers.Dense(32),
        # layers.LeakyReLU(alpha=0.2),
...
def make_AF_generator(latent_dimension, num_data_types, data_size, summary=False):
    mini_data, channels = 5, 32
    generator = keras.Sequential(
        [
            ...
            layers.Conv2DTranspose(32, (5, 5), strides=(1, 5), padding='same'),
            layers.Conv2DTranspose(32, (3, 1), strides=(2, 1), padding='valid'),
            layers.BatchNormalization(),
            layers.LeakyReLU(alpha=0.2),
            layers.Conv2DTranspose(32, (3, 3), strides=(2, 1), padding='same'),
            layers.BatchNormalization(),
            layers.LeakyReLU(alpha=0.2),
            layers.Conv2DTranspose(16, (5, 5), strides=(5, 1), padding='same'),
            layers.BatchNormalization(),
            layers.LeakyReLU(alpha=0.2),
            layers.Conv2DTranspose(16, (5, 5), strides=(5, 1), padding='same'),
            layers.BatchNormalization(),
